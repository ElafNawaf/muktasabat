"""SQLAlchemy 2.0 models that mirror app/models.py.

Both Flask and FastAPI map to the same Postgres tables. Alembic migrations
in /migrations remain the single source of truth for schema; these classes
just describe how FastAPI reads/writes them.
"""
